...
public class UserSettings {
    ...
    public List<PeriodTime> getPeriods() {
        return periods;
    }

    public void setPeriods(List<PeriodTime> periods) {
        this.periods = periods;
    }

    public List<List<String>> getCourseMatrix() {
        return courseMatrix;
    }

    public void setCourseMatrix(List<List<String>> m) {
        this.courseMatrix = m;
    }
}
